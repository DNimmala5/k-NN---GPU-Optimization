    ...
    private long buildFlatIndex(BuildIndexParams indexInfo) throws IOException {
        ...
        while (hasMoreDocs) {
            ...
            if (transferred) {
                ...
                debugLog("RIBS - BFI - Batch transferred with " + vectorCount + " vectors and " +
                        (batchSize * bytesPerVector) + " bytes");
                batchSize = 0;
            }
        ...
        if (batchSize > 0 && vectorTransfer.flush(false)) {
            ...
            debugLog("RIBS - BFI - Final batch flushed with " + batchSize + " vectors and " +
                    (batchSize * bytesPerVector) + " bytes");
        }
